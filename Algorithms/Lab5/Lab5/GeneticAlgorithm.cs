...
public class GeneticAlgorithm
{
    ...
    public void Iterate()
    {
        var breedingPool = CurrentGeneration.OrderBy(s => s.Cost).Take(BreedingPoolSize).ToArray(); //take best 10% 
        var best = breedingPool.Take(BreedingPoolSize / 5).ToArray(); //take best 20%
